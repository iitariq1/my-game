          ...
          <div className="animate-in bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div className="space-y-4 mb-8">
              <input
                ...
                maxLength={15}
                className="w-full text-2xl font-bold text-center text-gray-800 bg-gray-100 rounded-2xl py-4 px-6 focus:outline-none focus:ring-4 focus:ring-purple-300 placeholder-gray-500"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                className="w-full text-2xl font-bold text-center text-gray-800 bg-gray-100 rounded-2xl py-4 px-6 focus:outline-none focus:ring-4 focus:ring-pink-300 placeholder-gray-500"
              />
